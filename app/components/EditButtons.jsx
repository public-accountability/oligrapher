    ...
    return (
      <div id="editButtons" className="form-inline buttonGroup">
        ...
        { this.props.showInterlocksButton &&
          <button id="addInterlocksButton" className="btn btn-sm btn-default" title="search for entities related to selected" onClick={this.props.fetchInterlocks}>add interlocks</button>
        }
      </div>
    );
  }
