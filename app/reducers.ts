...
// run bin/action-types to get this list
type ActionTypes = 'SET_SAVED_DATA' | 'CREATE_ANNOTATION' | 'MOVE_ANNOTATION' | 'SHOW_ANNOTATION' | 'UPDATE_ANNOTATION' | 'CLEAR_HIGHLIGHTS' | 'REMOVE_ANNOTATION' | 'SET_HIGHLIGHTING' | 'SWAP_NODE_HIGHLIGHT' | 'SWAP_EDGE_HIGHLIGHT' | 'SWAP_CAPTION_HIGHLIGHT' | 'SET_EDITOR_MODE' | 'ADD_NODE' | 'UPDATE_NODE' | 'UPDATE_NODES' | 'REMOVE_NODE' | 'REMOVE_NODES' | 'CLICK_NODE' | 'MOUSE_ENTERED_NODE' | 'MOUSE_LEFT_NODE' | 'DRAG_NODE_START' | 'DRAG_NODE' | 'DRAG_NODE_STOP' | 'ADD_EDGE' | 'ADD_EDGES' | 'UPDATE_EDGE' | 'REMOVE_EDGE' | 'ADD_CAPTION' | 'UPDATE_CAPTION' | 'MOVE_CAPTION' | 'REMOVE_CAPTION' | 'APPLY_FORCE_LAYOUT' | 'INTERLOCKS_SUCCESS' | 'SET_SVG_TOP' | 'SET_SVG_BOTTOM' | 'SET_SVG_WIDTH' | 'SET_SVG_HEIGHT' | 'SET_ACTUAL_ZOOM' | 'SET_SVG_ZOOM' | 'SET_OFFSET' | 'SET_SVG_OFFSET' | 'SET_VIEWBOX' | 'RESET_VIEW' | 'COLLAPSE_HEADER' | 'EXPAND_HEADER' | 'RELEASE_NODE' | 'CLICK_EDGE' | 'CLICK_CAPTION' | 'ZOOM_IN' | 'ZOOM_OUT' | 'SET_ZOOM' | 'TOGGLE_ANNOTATIONS' | 'HIDE_ANNOTATIONS' | 'SHOW_ANNOTATIONS' | 'HIDE_HEADER' | 'SHOW_HEADER' | 'HIDE_ZOOM_CONTROL' | 'SHOW_ZOOM_CONTROL' | 'TOGGLE_TOOL' | 'CLOSE_TOOL' | 'OPEN_ADD_CONNECTIONS' | 'CLOSE_EDITOR' | 'OPEN_EDTIOR' | 'SAVE_REQUESTED' | 'SAVE_SUCCESS' | 'SAVE_FAILED' | 'SAVE_RESET' | 'CLONE_REQUESTED' | 'CLONE_SUCCESS' | 'CLONE_FAILED' | 'CLONE_RESET' | 'DELETE_REQUESTED' | 'DELETE_SUCCESS' | 'DELETE_FAILED' | 'DELETE_RESET' | 'FORCE_LAYOUT_REQUESTED' | 'ADD_EDITOR_REQUESTED' | 'ADD_EDITOR_SUCCESS' | 'ADD_EDITOR_FAILED' | 'ADD_EDITOR_RESET' | 'REMOVE_EDITOR_REQUESTED' | 'REMOVE_EDITOR_FAILED' | 'REMOVE_EDITOR_RESET' | 'INTERLOCKS_REQUESTED' | 'INTERLOCKS_FAILED' | 'INTERLOCKS_RESET' | 'LOCK_TAKEOVER_REQUESTED' | 'LOCK_TAKEOVER_SUCCESS' | 'LOCK_TAKEOVER_FAILED' | 'LOCK_TAKEOVER_RESET' | 'LOCK_RELEASE_REQUESTED' | 'LOCK_RELEASE_SUCCESS' | 'LOCK_RELEASE_FAILED' | 'LOCK_RELEASE_RESET' | 'EXPORT_IMAGE_REQUESTED' | 'EXPORT_IMAGE_SUCCESS' | 'EXPORT_IMAGE_FAILED' | 'EXPORT_IMAGE_RESET' | 'SET_SELECTING' | 'SWAP_NODE_SELECTION' | 'CLEAR_SELECTION' | 'UPDATE_ATTRIBUTE' | 'UPDATE_SETTING' | 'REMOVE_EDITOR_SUCCESS' | 'SET_LOCK'
