module.exports = {
  ...
  *   -> gets loaded before bootstrap so you can configure the variables used by bootstrap
  * mainSass:
  *   -> gets loaded after bootstrap, so you can override a bootstrap style.
  * NOTE, these are optional.
  *
  * Use preBootstrapCustomizations to change $brand-primary.
  * Ensure this preBootstrapCustomizations does not depend on other bootstrap variables.
   */
  ...
  /**
  * Use preBootstrapCustomizations to change $brand-primary.
  * Ensure this preBootstrapCustomizations does not
